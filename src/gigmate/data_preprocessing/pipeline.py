...
def dataset_creation_pipeline(stem_name: List[str], random_assortments_per_song: int, source_dir: str, merged_dir: str, augmented_dir: str, encoded_dir: str, split_dir: str):
    ...
    for split_dir in split_dirs:
        ...
        upload_dataset(path=split_dir, version=get_clearml_dataset_version(), tags=DATASET_TAGS, dataset=set)
