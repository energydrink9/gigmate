...
OUTPUT_FILES_DIR = '/Users/michele/Music/soundstripe/distorted'
...
def distort(original_audio: AudioSegment) -> AudioSegment:
...
def distort_all(source_directory: str, output_directory: str):
    ...
    for filename in tqdm(files, "Distorting audio tracks"):
